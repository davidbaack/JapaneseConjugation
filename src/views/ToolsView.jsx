...
export default function ToolsView() {
  ...
  const activeTool = TOOL_TABS.find((tool) => tool.id === active) || TOOL_TABS[0];
          ...
          {TOOL_TABS.map((tool) => {
            ...
            return (
              <button
                ...
                className={`inline-flex min-h-10 shrink-0 items-center gap-2 rounded-lg px-3 py-2 text-sm transition ${
                  activeTool
