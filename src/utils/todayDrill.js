...
import { ruleWeakScore, weakTypeIdsForState } from './storage.js';
...
export function buildTodayDrillPlan(
  ...
  return {
    ...
    reviewLimit: options.reviewLimit || TODAY_DRILL_LIMIT,
...
export function practicePrefsForTodayDrill(prefs = DEFAULT_PREFS, plan) {
  return {
    ...
    minimalPairSetId: '',
    reviewLimit: plan?.reviewLimit || TODAY_DRILL_LIMIT,
